...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour must have less or equal than 40 chars'],
      minlength: [10, 'A tour must have less or equal than 10 chars']
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function(val) {
          //thsi only points to current doc on new document creation
...
//DOCUMENT MIDDLEWARE, runs before for .save() and .create()
